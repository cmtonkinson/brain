# Valkey Substrate
Valkey-backed *Substrate* *Resource* used by the Cache *Service* for scoped cache storage, queue operations, and substrate liveness checks.
...
This *Resource* is owned by `service_cache` via
