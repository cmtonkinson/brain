"""Tests for policy conflict reporting."""
...
from scripts.policy_conflicts import generate_conflict_report
...
def test_conflict_report_detects_channel_overlap(tmp_path: Path) -> None:
    """Ensure channel allow/deny overlaps are reported as conflicts."""
    skill_registry = {
    ...
    assert "channel_allow_deny_overlap" in conflict_types
