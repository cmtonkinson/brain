"""Language Model Service-owned Postgres runtime wiring."""
...
class LanguageModelPostgresRuntime:
    """Concrete LMS handle for schema-scoped Postgres access."""
    ...
    def from_settings(
        ...
        """Build LMS DB runtime from typed application settings."""
...
def language_model_postgres_schema() -> str:
    """Resolve canonical LMS schema name from component identity."""
