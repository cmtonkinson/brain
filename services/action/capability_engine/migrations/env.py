"""Alembic environment for Capability Engine Service schema migrations."""
...
from services.action.capability_engine.data.schema import metadata
...
if not sqlalchemy_url:
    raise ValueError("substrate.postgres.url is required for CES migrations")
