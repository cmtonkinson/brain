"""Alembic environment for Embedding Service schema migrations."""
...
from services.state.embedding.data.schema import metadata
...
if not sqlalchemy_url:
    raise ValueError("substrate.postgres.url is required for Embedding migrations")
