"""Real-provider integration tests for Embedding Postgres repository."""
...
from services.state.embedding.data.runtime import EmbeddingPostgresRuntime
from services.state.embedding.domain import EmbeddingStatus
