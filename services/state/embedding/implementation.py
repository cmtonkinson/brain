...
from services.state.embedding.interfaces import (
    EmbeddingRepository,
    QdrantIndexBackend,
)
from services.state.embedding.service import EmbeddingService
from services.state.embedding.validation import (
...
class _Missing:
    """Sentinel distinguishing omitted payload from explicit None."""


_NO_PAYLOAD = _Missing()
...
class DefaultEmbeddingService(EmbeddingService):
    """Default Embedding implementation with Postgres-backed state and Qdrant derived index."""
    ...
    def health(self, *, meta: EnvelopeMeta) -> Envelope[HealthStatus]:
        """Return Embedding readiness based on owned Postgres repository availability."""
        validate_meta(meta)
        try:
    ...
    def upsert_spec(
        ...
        *,
        ...
        spec_request, errors = validate_service_request(
            meta=meta,
    ...
    def upsert_source(
        ...
        *,
        ...
        source_request, errors = validate_service_request(
            meta=meta,
    ...
    def upsert_chunk(
        ...
        *,
        ...
        chunk_request, errors = validate_service_request(
            meta=meta,
    ...
    def upsert_chunks(
        ...
        *,
        ...
        chunk_batch, errors = validate_service_request(
            meta=meta,
    ...
    def upsert_embedding_vector(
        ...
        *,
        ...
        vector_request, errors = validate_service_request(
            meta=meta,
    ...
    def upsert_embedding_vectors(
        ...
        *,
        ...
        vector_batch, errors = validate_service_request(
            meta=meta,
    ...
    def delete_source(self, *, meta: EnvelopeMeta, source_id: str) -> Envelope[bool]:
        ...
        try:
            embedding_pairs = [
                (r.chunk_id, r.spec_id)
                for r in self._repository.list_embeddings_by_source(
                    source_id=source_request.source_id,
                    spec_id="",
                    limit=self._settings.max_list_limit,
                )
            ]
            ...
            for chunk_id, spec_id in embedding_pairs:
                self._delete_derived_point_best_effort(
    ...
    def get_embedding(
        ...
        *,
        ...
        embedding_request, errors = validate_service_request(
            meta=meta,
    ...
    def list_embeddings_by_source(
        ...
        *,
        ...
        list_request, errors = validate_service_request(
            meta=meta,
    ...
    def list_embeddings_by_status(
        ...
        *,
        ...
        status_request, errors = validate_service_request(
            meta=meta,
    ...
    def search_embeddings(
        ...
        *,
        ...
        search_request, errors = validate_service_request(
            meta=meta,
    ...
    def _clamp_limit(self, limit: int) -> int:
        ...
        if limit <= 0:
            return min(self._settings.default_list_limit, self._settings.max_list_limit)
...
def _canonical_spec_string(
    *, provider: str, name: str, version: str, dimensions: int
    ...
    for part in parts:
        ...
        cleaned = _CANON_RE.sub("", lowered)
        if cleaned != lowered:
            _LOGGER.warning(
                "Non-canonical chars stripped from spec string: original=%r cleaned=%r",
                lowered,
                cleaned,
            )
