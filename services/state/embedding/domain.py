"""Domain models for the Embedding Service (Embedding).
...
class SourceRecord(BaseModel):
    """Authoritative source row owned by Embedding."""
...
class ChunkRecord(BaseModel):
    """Authoritative logical chunk row owned by Embedding."""
...
class SearchEmbeddingMatch(BaseModel):
    """Derived semantic-search match returned by Embedding query operations."""
...
class HealthStatus(BaseModel):
    """Embedding and owned dependency readiness status payload."""
