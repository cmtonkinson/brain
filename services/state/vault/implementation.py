"""Concrete Vault Service implementation."""
...
from services.state.vault.domain import (
    FileEdit,
    HealthStatus,
    SearchFileMatch,
    VaultEntry,
...
from services.state.vault.validation import (
    AppendFileRequest,
...
class DefaultVaultService(VaultService):
    """Default Vault implementation backed by Obsidian Local REST API substrate."""
    ...
    def health(self, *, meta: EnvelopeMeta) -> Envelope[HealthStatus]:
        """Return Vault readiness based on owned Obsidian substrate health."""
        validate_meta(meta)
    ...
    def _substrate_failure(
        ...
        *,
        ...
        return failure(
            ...
            errors=[
                internal_error(
                    str(exc) or "unexpected vault failure",
