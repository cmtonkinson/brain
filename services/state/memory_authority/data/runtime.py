"""MAS-owned Postgres runtime wiring."""
...
class MemoryPostgresRuntime:
    """Concrete MAS-owned handle for schema-scoped Postgres access."""
    ...
    def from_settings(cls, settings: CoreRuntimeSettings) -> "MemoryPostgresRuntime":
        """Build MAS DB runtime from typed application settings."""
...
def memory_postgres_schema() -> str:
    """Resolve canonical MAS schema name from component identity."""
