"""Adapter tests for OAS gRPC transport/domain error mapping semantics."""
# ruff: noqa: E402
...
from services.state.object_authority.api import _abort_for_transport_errors  # noqa: E402
