"""Alembic environment for Object Authority Service schema migrations."""
...
from services.state.object_authority.data.schema import metadata
...
if not sqlalchemy_url:
    raise ValueError("components.substrate_postgres.url is required for OAS migrations")

schema_name = object_postgres_schema()
