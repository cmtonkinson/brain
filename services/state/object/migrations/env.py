"""Alembic environment for Object Service schema migrations."""
...
from services.state.object.data.schema import metadata
...
if not sqlalchemy_url:
    raise ValueError("substrate.postgres.url is required for Object migrations")
