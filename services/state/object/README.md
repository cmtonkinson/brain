# Object Service
State *Service* that owns content-addressed object metadata authority and
durable blob lifecycle semantics on top of Postgres metadata and a SeaweedFS
substrate.

------------------------------------------------------------------------
## What This Component Is
`services/state/object/` is the authoritative Tier 2 *Service* for
...
Object is a State-System *Service* (`tier=2`, `plane="state"`) and declares
