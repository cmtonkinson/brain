"""Alembic environment for Delegation Service schema migrations."""
...
from services.reason.delegation.data.schema import metadata
...
if not sqlalchemy_url:
    raise ValueError("substrate.postgres.url is required for Delegation migrations")

schema_name = delegation_postgres_schema()
