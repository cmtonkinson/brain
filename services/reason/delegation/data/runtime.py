"""Delegation-owned Postgres runtime wiring."""
...
class DelegationPostgresRuntime:
    """Concrete Delegation-owned handle for schema-scoped Postgres access."""
    ...
    def from_settings(
        ...
        """Build Delegation DB runtime from typed application settings."""
...
def delegation_postgres_schema() -> str:
    """Resolve canonical Delegation schema name from component identity."""
