...
`services/reason/ingestion/` is the authoritative Tier 2 _Service_ for deterministic content ingestion in Brain's Control System.
...
Ingestion Service is a Control-System _Service_ (`tier=2`, `plane="reason"`). It owns the `service_ingestion` Postgres schema exclusively.
