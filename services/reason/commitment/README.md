...
`services/reason/commitment/` is the authoritative Tier 2 _Service_ for commitment tracking in Brain's Control System.
...
Commitment Service is a Control-System _Service_ (`tier=2`, `plane="reason"`). It owns the `service_commitment` Postgres schema exclusively.
