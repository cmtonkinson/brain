"""Alembic environment for Policy Service schema migrations."""
...
from services.reason.policy.data.schema import metadata
...
if not sqlalchemy_url:
    raise ValueError("substrate.postgres.url is required for Policy migrations")

schema_name = policy_service_postgres_schema()
