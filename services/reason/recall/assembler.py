"""Context assembly module for Recall Service."""

from __future__ import annotations

from lib.shared.envelope import EnvelopeMeta
from services.reason.recall.dialogue import DialogueModule
from services.reason.recall.domain import ContextBlock
from services.reason.recall.focus import FocusModule
    ...
    def assemble(
        ...
        *,
        ...
        return ContextBlock(
            ...
            # TODO(cmtonkinson): Inject relevant Reference snippets via Embedding/Vault.
            reference_snippets=[],
        )
