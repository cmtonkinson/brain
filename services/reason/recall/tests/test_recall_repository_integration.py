"""Real-provider integration tests for Recall Postgres repository."""

from __future__ import annotations

import pytest

from services.reason.recall.data.repository import PostgresMemoryRepository
from services.reason.recall.data.runtime import MemoryPostgresRuntime
