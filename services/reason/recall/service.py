"""Authoritative in-process Python API for Recall Service."""
...
class RecallService(ABC):
    """Public API for Recall Service context and session operations."""
...
def build_recall_service(
    *,
    ...
    """Build default Recall implementation from typed settings."""
    from services.reason.recall.implementation import (
        DefaultRecallService,
    )

    return DefaultRecallService.from_settings(
        settings=settings,
