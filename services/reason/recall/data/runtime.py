"""Recall-owned Postgres runtime wiring."""
...
class MemoryPostgresRuntime:
    """Concrete Recall-owned handle for schema-scoped Postgres access."""
    ...
    @classmethod
    def from_settings(cls, settings: CoreRuntimeSettings) -> "MemoryPostgresRuntime":
        """Build Recall DB runtime from typed application settings."""
...
def memory_postgres_schema() -> str:
    """Resolve canonical Recall schema name from component identity."""
