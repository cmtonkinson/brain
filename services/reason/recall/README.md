# Recall Service
State _Service_ that owns session-scoped Dialogue and Focus context assembly for the Brain Assistant.
------------------------------------------------------------------------
## What This Component Is
`services/reason/recall/` is the authoritative Tier 2 _Service_ for agent recall and context assembly behavior.
...
Recall is a State-System _Service_ (`tier=2`, `plane="state"`) and does not declare ownership of a dedicated T1 _Resource_ component; it uses shared Postgres infrastructure for authoritative state.
