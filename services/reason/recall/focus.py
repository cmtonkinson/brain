"""Focus module for Recall Service."""
...
from services.reason.recall.domain import FocusRecord, estimate_token_count
...
class FocusModule:
    ...
    def _request_compaction(
        ...
        *,
        ...
        """Call Language quick profile to compact focus content."""
        retry_instruction = ""
        if retry:
            retry_instruction = (
