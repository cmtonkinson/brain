...
def _schema() -> str:
    """Resolve canonical Recall-owned schema name."""
...
def upgrade() -> None:
    """Create Recall authoritative schema objects."""
    schema = _schema()
    ...
    op.create_table(
        ...
        sa.Column("dialogue_start_turn_id", ulid_domain_type(schema), nullable=True),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        "turn",
        sa.Column("id", ulid_domain_type(schema), primary_key=True, nullable=False),
        sa.Column("session_id", ulid_domain_type(schema), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", ulid_domain_type(schema), primary_key=True, nullable=False),
        sa.Column("session_id", ulid_domain_type(schema), nullable=False),
        sa.Column("start_turn_id", ulid_domain_type(schema), nullable=False),
        sa.Column("end_turn_id", ulid_domain_type(schema), nullable=False),
        sa.Column("content", sa.Text(), nullable=False),
...
def downgrade() -> None:
    """Drop Recall authoritative schema objects."""
    schema = _schema()
