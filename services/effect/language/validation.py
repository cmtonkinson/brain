"""Pydantic ingress validation models for Language Service."""
...
from services.effect.language.domain import ChatToolCall
...
class ChatRequest(_ValidationModel):
    ...
    def _validate_prompt(cls, value: str, info: ValidationInfo) -> str:
        """Validate one non-empty prompt while preserving verbatim whitespace."""
        if value == "":
