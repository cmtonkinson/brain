"""Alembic environment for Language Service schema."""
...
from services.effect.language.data.schema import metadata
...
if not sqlalchemy_url:
    raise ValueError("substrate.postgres.url is required for Language migrations")
...
def _schema() -> str:
    """Return canonical Language-owned schema name."""
    return schema_name
