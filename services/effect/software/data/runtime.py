"""Software Service-owned Postgres runtime wiring."""
...
class SoftwarePostgresRuntime:
    """Concrete Software handle for schema-scoped Postgres access."""
    ...
    @classmethod
    def from_settings(cls, settings: CoreRuntimeSettings) -> "SoftwarePostgresRuntime":
        """Build Software DB runtime from typed application settings."""
...
def software_postgres_schema() -> str:
    """Resolve canonical Software schema name from component identity."""
