"""Alembic environment for Software Service schema."""
...
from services.effect.software.data.schema import metadata
...
if not sqlalchemy_url:
    raise ValueError("substrate.postgres.url is required for Software migrations")

schema_name = software_postgres_schema()
config.set_main_option("sqlalchemy.url", str(sqlalchemy_url))


def _schema() -> str:
    """Return canonical Software-owned schema name."""
    return schema_name
