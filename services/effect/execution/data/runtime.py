"""Execution-owned Postgres runtime wiring."""
...
class ExecutionPostgresRuntime:
    """Concrete Execution handle for schema-scoped Postgres access."""
    ...
    @classmethod
    def from_settings(cls, settings: CoreRuntimeSettings) -> "ExecutionPostgresRuntime":
        """Build Execution DB runtime from typed application settings."""
...
def execution_postgres_schema() -> str:
    """Resolve canonical Execution schema name from component identity."""
