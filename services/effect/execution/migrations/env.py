"""Alembic environment for Execution Service schema migrations."""
...
from services.effect.execution.data.schema import metadata
...
if not sqlalchemy_url:
    raise ValueError("substrate.postgres.url is required for Execution migrations")

schema_name = execution_postgres_schema()
