...
from lib.shared.envelope import Envelope, EnvelopeKind, EnvelopeMeta, Payload, new_meta
...
def _request(meta: EnvelopeMeta, payload: dict[str, Any]) -> OpInvocationRequest:
...
class _StubRuntime:
    def invoke_nested(self, *, op_id: str, input_payload: dict[str, Any]):
