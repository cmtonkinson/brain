...
job_intents = sa.Table(
    ...
    sa.Column("superseded_by_id", sa.LargeBinary(16), nullable=True),
    schema=_SCHEMA,
)
...
jobs = sa.Table(
    ...
    metadata,
    ulid_primary_key_column("id", schema_name=_SCHEMA),
    sa.Column("job_intent_id", sa.LargeBinary(16), nullable=False),
...
executions = sa.Table(
    ...
    metadata,
    ulid_primary_key_column("id", schema_name=_SCHEMA),
    sa.Column("job_id", sa.LargeBinary(16), nullable=False),
    sa.Column("job_intent_id", sa.LargeBinary(16), nullable=False),
...
execution_audits = sa.Table(
    ...
    metadata,
    ulid_primary_key_column("id", schema_name=_SCHEMA),
    sa.Column("execution_id", sa.LargeBinary(16), nullable=False),
    sa.Column("job_id", sa.LargeBinary(16), nullable=False),
    sa.Column("status", sa.String(32), nullable=False),
    sa.Column("attempt_number", sa.Integer(), nullable=False),
    sa.Column("retry_after", sa.DateTime(timezone=True), nullable=True),
...
review_items = sa.Table(
    ...
    metadata,
    ulid_primary_key_column("id", schema_name=_SCHEMA),
    sa.Column("review_output_id", sa.LargeBinary(16), nullable=False),
    sa.Column("job_id", sa.LargeBinary(16), nullable=False),
