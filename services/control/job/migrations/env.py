"""Alembic environment for Job Service schema migrations."""
...
from services.control.job.data.schema import metadata
...
if not sqlalchemy_url:
    raise ValueError("substrate.postgres.url is required for Job Service migrations")

schema_name = job_postgres_schema()
