"""Alembic environment for Commitment Service schema migrations."""
...
from services.control.commitment.data.schema import metadata
...
if not sqlalchemy_url:
    raise ValueError(
        "substrate.postgres.url is required for Commitment Service migrations"
    )

schema_name = commitment_postgres_schema()
