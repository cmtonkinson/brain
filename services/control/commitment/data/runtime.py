"""Commitment Service-owned Postgres runtime wiring."""
...
class CommitmentPostgresRuntime:
    """Concrete Commitment Service-owned handle for schema-scoped Postgres access."""
...
def commitment_postgres_schema() -> str:
    """Resolve canonical Commitment Service schema name from component identity."""
