"""Alembic environment for Ingestion Service schema migrations."""
...
from services.control.ingestion.data.schema import metadata
...
if not sqlalchemy_url:
    raise ValueError(
        "substrate.postgres.url is required for Ingestion Service migrations"
    )

schema_name = ingestion_postgres_schema()
