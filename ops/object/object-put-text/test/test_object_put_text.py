"""Unit tests for the object-put-text logic op."""
...
def _load_execute():
    ...
    spec = importlib.util.spec_from_file_location("object_put_text_execute", path)
...
def test_execute_encodes_text_and_delegates() -> None:
    ...
    assert seen["call_target"] == "service_object.put_object"
