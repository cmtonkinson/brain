...
class EnvironmentContextContentPart(_ContentPartModel):
    """One transient environment-context segment."""

    kind: Literal["environment_context"] = "environment_context"
...
class InferenceRequest(_InferenceModel):
    ...
    environment_context: InferenceEnvironmentContext = Field(
        default_factory=InferenceEnvironmentContext
    )
