...
def test_sender_allowed_by_channel(monkeypatch) -> None:
    ...
    monkeypatch.setattr(settings, "allowed_senders", [], raising=False)
...
def test_sender_allowed_legacy_list(monkeypatch) -> None:
    monkeypatch.setattr(settings, "allowed_senders_by_channel", {}, raising=False)
    monkeypatch.setattr(settings, "allowed_senders", ["+15550001111"], raising=False)
